...
//
bool Nodes::find(const long long& id, double& lat, double& lon, bool& isEntrance) const
{
  // Creates an empty Node if the id not found
  // We won't know if the search was successful or not
